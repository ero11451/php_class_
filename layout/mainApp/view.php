            ...
            <div class="hidden md:flex md:items-center md:w-auto w-full order-3 md:order-1" id="menu">
                <nav>
                    <ul class="md:flex items-center justify-between text-base text-gray-700 pt-4 md:pt-0">
                        <li><a class="inline-block no-underline hover:text-black hover:underline py-2 px-4" href="/products">Shop</a></li>
                        <?php if (!empty($_SESSION["user"])) {
                            echo '<li><a class="inline-block no-underline hover:text-black hover:underline py-2 px-4" href="/logout">logout</a></li>';
                        }else{
                            echo '<li><a class="inline-block no-underline hover:text-black hover:underline py-2 px-4" href="/login">SignIn or SignUp</a></li>';
                        }?>
